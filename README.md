...
Disclaimer (pt_BR)
==========
Este repositório é uma versão modificada do pacote [spatie/laravel-query-builder](https://github.com/spatie/laravel-query-builder). Algumas mudanças foram implementadas para uma melhor integração com as demais libs do projeto [Versatile](https://github.com/versatilecms).
